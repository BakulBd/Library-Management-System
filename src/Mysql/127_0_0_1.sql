...
-- Database: `library_ms`
--
CREATE DATABASE IF NOT EXISTS `library_ms` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `library_ms`;
...
(1, 'Bakul Ahmed', '9080965525', 'Vellore, India', '18MIS0395', '1234', 'Admin'),
